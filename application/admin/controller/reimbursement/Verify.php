...
namespace app\admin\controller\reimbursement;
...
class Verify extends Backend
{
    ...
    /**
     * Verify模型对象
     * @var \app\admin\model\reimbursement\Verify
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\ReimbursementVerify;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            foreach ($list as $row) {
                $row->visible(['id','project_agreedata','finance_agreedata','createtime']);
                $row->visible(['info']);
