define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'reimbursement/info/index',
                    add_url: 'reimbursement/info/add',
                    edit_url: 'reimbursement/info/edit',
                    del_url: 'reimbursement/info/del',
                    multi_url: 'reimbursement/info/multi',
                    table: 'reimbursement_info',
                }
            });
