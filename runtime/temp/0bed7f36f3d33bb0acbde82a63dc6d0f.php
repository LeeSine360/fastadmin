...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-bank_name" class="form-control" name="row[bank_name]" type="text" value="<?php echo $row['bank_name']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Datumdata'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            
            <div class="checkbox">
            <?php if(is_array($datumdataList) || $datumdataList instanceof \think\Collection || $datumdataList instanceof \think\Paginator): if( count($datumdataList)==0 ) : echo "" ;else: foreach($datumdataList as $key=>$vo): ?>
            <label for="row[datumdata][]-<?php echo $key; ?>"><input id="row[datumdata][]-<?php echo $key; ?>" name="row[datumdata][]" type="checkbox" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['datumdata'])?$row['datumdata']:explode(',',$row['datumdata']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
