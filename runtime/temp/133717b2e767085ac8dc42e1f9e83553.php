    ...
    <form action="" class="form-commonsearch">
        <div style="border-radius:2px;margin-bottom:10px;background:#f5f5f5;padding:20px;">
            <div class="row">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-3" style="min-height:68px;">
