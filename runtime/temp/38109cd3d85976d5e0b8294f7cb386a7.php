...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-starttime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[starttime]" type="text" value="<?php echo $row['starttime']?datetime($row['starttime']):''; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-surveycontent" class="form-control" rows="5" name="row[surveycontent]" cols="50"><?php echo htmlentities($row['surveycontent']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
