...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-project_content" class="form-control editor" rows="5" name="row[project_content]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-finace_content" class="form-control editor" rows="5" name="row[finace_content]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
