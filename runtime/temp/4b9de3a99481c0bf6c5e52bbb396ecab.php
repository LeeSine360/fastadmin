...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[savedata]-<?php echo $key; ?>"><input id="row[savedata]-<?php echo $key; ?>" name="row[savedata]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['savedata'])?$row['savedata']:explode(',',$row['savedata']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
