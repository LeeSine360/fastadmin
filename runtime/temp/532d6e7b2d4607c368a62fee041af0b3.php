...
<script type="text/javascript">
    ...
    <div class="row form-row-height">
        ...
        <div class="col-xs-12 col-sm-3">
            <input id="c-project_info_id" data-rule="required" data-source="project/info/index" showField='short' class="form-control selectpage" name="row[project_info_id]" type="text" value="<?php echo htmlentities($row['project_info_id']); ?>">
        </div>
    ...
    <div class="row form-row-height">
        ...
        <div class="col-xs-12 col-sm-3">
            <div class="input-group">
                <input id="c-price" class="form-control" step="1000" name="row[price]" type="number" value="<?php echo htmlentities($row['price']); ?>">
                <span class="input-group-addon">元</span>
            </div>  
        </div>
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Number'); ?>:</label>
        <div class="col-xs-12 col-sm-3">
            <input id="c-number" data-rule="required" class="form-control" step="1" name="row[number]" type="number" value="<?php echo htmlentities($row['number']); ?>">
        </div>
    </div>
    <div class="row form-row-height">
    ...
    <div class="row form-row-height">
        ...
        <div class="col-xs-12 col-sm-3">
            <input id="c-operatorname" class="form-control" name="row[operatorname]" type="text" value="<?php echo htmlentities($row['contacts']); ?>">
        </div>
