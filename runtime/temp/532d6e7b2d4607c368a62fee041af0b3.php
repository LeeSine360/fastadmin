...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-project_section_ids" data-rule="required" data-source="project/section/index" data-multiple="true" class="form-control selectpage" name="row[project_section_ids]" type="text" value="<?php echo htmlentities($row['project_section_ids']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-rule="required" data-source="category/selectpage" data-params='{"custom[type]":"contract_info"}' class="form-control selectpage" name="row[category_id]" type="text" value="<?php echo htmlentities($row['category_id']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-total" class="form-control" name="row[total]" type="number" value="<?php echo htmlentities($row['total']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Save'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-save" class="form-control" name="row[save]" type="number" value="<?php echo htmlentities($row['save']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Operatorname'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-operatorname" class="form-control" name="row[operatorname]" type="text" value="<?php echo htmlentities($row['operatorname']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Operatorphone'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-operatorphone" class="form-control" name="row[operatorphone]" type="text" value="<?php echo htmlentities($row['operatorphone']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Settlement'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-settlement" class="form-control " rows="5" name="row[settlement]" cols="50"><?php echo htmlentities($row['settlement']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
