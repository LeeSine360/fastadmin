<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/Users/work/WEB/fastadmin/public/../application/admin/view/contract/info/edit.html";i:1554638041;s:68:"/Users/work/WEB/fastadmin/application/admin/view/layout/default.html";i:1553167192;s:65:"/Users/work/WEB/fastadmin/application/admin/view/common/meta.html";i:1553167192;s:67:"/Users/work/WEB/fastadmin/application/admin/view/common/script.html";i:1553167192;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="row form-row-height">
        ...
        <!--<div class="col-xs-12 col-sm-3">
            <input id="c-category_id" data-rule="required" data-source="category/selectpage" data-params='{"custom[type]":"contract_info"}' class="form-control selectpage input-left-padding45" name="row[category_id]" type="text" value="<?php echo $row['category_id']; ?>">
        </div>
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Label_ids'); ?>:</label>
        <div class="col-xs-12 col-sm-3">
            <input id="c-label_ids" data-rule="required" data-source="label/index" data-multiple="true" class="form-control selectpage input-left-padding45" name="row[label_ids]" type="text" value="<?php echo $row['label_ids']; ?>">
        </div>-->
    </div>
    <div class="row form-row-height">
