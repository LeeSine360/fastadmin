<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/Users/work/WEB/fastadmin/public/../application/admin/view/company/bill/edit.html";i:1554898136;s:68:"/Users/work/WEB/fastadmin/application/admin/view/layout/default.html";i:1553167192;s:65:"/Users/work/WEB/fastadmin/application/admin/view/common/meta.html";i:1553167192;s:67:"/Users/work/WEB/fastadmin/application/admin/view/common/script.html";i:1553167192;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-payment" data-rule="required" class="form-control" name="row[payment]" type="number" value="<?php echo $row['payment']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Unpayment'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-unpayment" data-rule="required" class="form-control" name="row[unpayment]" type="number" value="<?php echo $row['unpayment']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-remarkcontent" class="form-control" name="row[remarkcontent]"><?php echo $row['remarkcontent']; ?></textarea>
        </div>
    </div>
