...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-contract_info_id" data-rule="required" data-source="contract/info/index" class="form-control selectpage" name="row[contract_info_id]" type="text" value="<?php echo $row['contract_info_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[agreedata]-<?php echo $key; ?>"><input id="row[agreedata]-<?php echo $key; ?>" name="row[agreedata]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['agreedata'])?$row['agreedata']:explode(',',$row['agreedata']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-opinion" class="form-control" name="row[opinion]" type="text" value="<?php echo $row['opinion']; ?>">
        </div>
    </div>
