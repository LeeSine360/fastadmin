...
<div class="form-group">
    ...
    <label class="col-xs-12 col-sm-2 text-right">已拨付金额:</label>
    <div class="col-xs-12 col-sm-4">20000000.00</div>
</div>
<div class="form-group">
    <label class="col-xs-12 col-sm-2 text-right">供应商欠款金额:</label>
    <div class="col-xs-12 col-sm-4">230000000.00</div>
    <label class="col-xs-12 col-sm-2 text-right">合同详情:</label>
    <div class="col-xs-12 col-sm-4">点击查看</div>
</div>
<div class="form-group">
