...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-payname" class="form-control" name="row[payname]" type="text">
        </div>
    </div>
    <div class="form-group">
