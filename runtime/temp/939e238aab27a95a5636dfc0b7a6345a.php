...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4"><?php echo htmlentities($list['projectName']); ?></div>
    </div>
    <div class="form-group">
        <label class="col-xs-12 col-sm-2 text-right">标段名称:</label>
        <div class="col-xs-12 col-sm-4"><?php echo htmlentities($list['sectionName']); ?></div>
        <label class="col-xs-12 col-sm-2 text-right">项目经理:</label>
        <div class="col-xs-12 col-sm-4"><?php echo htmlentities($list['managerName']); ?></div>
    </div>

    <div class="form-group">
        <label class="col-xs-12 col-sm-2 text-right">供应商名称:</label>
        <div class="col-xs-12 col-sm-4"><?php echo htmlentities($list['companyName']); ?></div>
        <label class="col-xs-12 col-sm-2 text-right">联系电话:</label>
        <div class="col-xs-12 col-sm-4"><?php echo htmlentities($list['companyPhone']); ?></div>
    </div>
    <div class="form-group">
        <label class="col-xs-12 col-sm-2 text-right">合同名称:</label>
        <div class="col-xs-12 col-sm-4"><?php echo htmlentities($list['contractName']); ?></div>
        <label class="col-xs-12 col-sm-2 text-right">合同总价:</label>
        <div class="col-xs-12 col-sm-4"><?php echo htmlentities($list['contractPrice']); ?></div>
    </div>
    <div class="form-group">
        <label class="col-xs-12 col-sm-2 text-right">合同类型:</label>
        <div class="col-xs-12 col-sm-4"><?php echo htmlentities($list['categoryName']); ?></div>
        <label class="col-xs-12 col-sm-2"></label>
        <div class="col-xs-12 col-sm-4">
            <a href="javascript:;" data-url="/admin/contract/verify/payinfo/id/<?php echo $list['categoryId']; ?>" class="btn btn-default" style="font-size:12px;color:dodgerblue;">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-10"><?php echo htmlentities($list['contractSettlement']); ?></div>
    </div>
    <div class="form-group">
