...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-surveycontent" class="form-control editor" rows="5" name="row[surveycontent]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Project_build_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-project_build_id" data-source="project/build/index" class="form-control selectpage" name="row[project_build_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
