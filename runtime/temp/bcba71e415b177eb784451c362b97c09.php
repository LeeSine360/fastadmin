...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-status" class="form-control" name="row[status]" type="text" value="<?php echo htmlentities($row['status']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Regcapital'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-regCapital" class="form-control" name="row[regCapital]" type="text" value="<?php echo htmlentities($row['regCapital']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Scope'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-scope" class="form-control" name="row[scope]" type="text" value="<?php echo htmlentities($row['scope']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-payname" class="form-control" name="row[payname]" type="text" value="<?php echo htmlentities($row['payname']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-remarkcontent" class="form-control" rows="5" name="row[remarkcontent]" cols="50"><?php echo htmlentities($row['remarkcontent']); ?></textarea>
        </div>
    </div>
