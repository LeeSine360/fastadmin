...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[state][]-<?php echo $key; ?>"><input id="row[state][]-<?php echo $key; ?>" name="row[state][]" type="checkbox" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',""))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Completedata'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            
            <div class="radio">
            <?php if(is_array($completedataList) || $completedataList instanceof \think\Collection || $completedataList instanceof \think\Paginator): if( count($completedataList)==0 ) : echo "" ;else: foreach($completedataList as $key=>$vo): ?>
            <label for="row[completedata]-<?php echo $key; ?>"><input id="row[completedata]-<?php echo $key; ?>" name="row[completedata]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"no"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Situationcontext'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-situationcontext" class="form-control " rows="5" name="row[situationcontext]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
