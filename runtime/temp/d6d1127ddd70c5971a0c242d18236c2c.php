...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-project_manager_id" data-rule="required" data-source="project/manager/index" class="form-control selectpage" name="row[project_manager_id]" type="text" value="<?php echo htmlentities($row['project_manager_id']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-surveycontent" class="form-control editor" rows="5" name="row[surveycontent]" cols="50"><?php echo htmlentities($row['surveycontent']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
