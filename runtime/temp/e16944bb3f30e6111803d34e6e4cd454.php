...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Categorydata'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            
            <div class="radio">
            <?php if(is_array($categorydataList) || $categorydataList instanceof \think\Collection || $categorydataList instanceof \think\Paginator): if( count($categorydataList)==0 ) : echo "" ;else: foreach($categorydataList as $key=>$vo): ?>
            <label for="row[categorydata]-<?php echo $key; ?>"><input id="row[categorydata]-<?php echo $key; ?>" name="row[categorydata]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"vat"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Invoicedate'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-invoicedate" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[invoicedate]" type="text" value="<?php echo date('Y-m-d'); ?>">
        </div>
    </div>
    <div class="form-group">
